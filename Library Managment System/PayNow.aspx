<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PayNow.aspx.cs" Inherits="Library_Managment_System.PayNow" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />
        ...
        <script>
            var orderId = "<%=orderId%>"
            var totalFine = "<%=totalFine%>";
            var options = {
                "name": "<%=product%>",
                "description": "<%=product%> - Total Fine: " + totalFine + " Rupees", // Include totalFine in the description
                "order_id": orderId,
                "prefill": {
                    "name": "<%=name%>",
            "email": "<%=email%>",
